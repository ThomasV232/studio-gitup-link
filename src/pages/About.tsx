...
const processSummary = [
  {
    title: "Co-création",
    description:
      "Ateliers vision, personas, scripts co-validés, moodboards immersifs, repérages 3D et planning partagé.",
  },
  {
    title: "Production",
    description:
      "Tournages agiles (Sony Burano 8K, drone FPV, audio HF), direction artistique et pipeline IA supervisé.",
  },
  {
    title: "Activation",
    description:
      "Montage, étalonnage ACES, déclinaisons verticales, sous-titres dynamiques et diffusion multicanale.",
  },
];
      ...
      <div className="relative mx-auto flex w-full max-w-6xl flex-col gap-16 px-6 pb-24 pt-28 sm:px-10">
        ...
        <header className="grid gap-10 rounded-[3.5rem] border border-white/10 bg-white/5 p-10 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
          <div className="space-y-6">
            ...
            <p className="text-sm text-white/75">
              Diplômé en cinéma et passionné par l&apos;innovation, j&apos;accompagne depuis 2016 des marques, startups
              et institutions pour créer des expériences vidéo impactantes. Basé à Paris, je déploie un studio mobile
              (France & Europe) avec une stack Septembre 2025 mêlant captation haut de gamme, IA générative et outils de
              pilotage data.
            </p>
            <div className="grid gap-3 text-sm text-white/70">
              ...
              <p>
                • Stack : Sony Burano 8K, FX6, DJI Inspire 3, Runway Gen-5, Sora, DaVinci Neural 19
              </p>
            </div>
          ...
          <div className="relative flex h-full items-center justify-center">
            <div className="relative h-[320px] w-[260px] overflow-hidden rounded-[2.75rem] border border-white/15 bg-white/10">
              ...
              <div
                className="absolute inset-0 animate-[pulse_10s_ease_infinite] bg-[radial-gradient(circle_at_30%_20%,rgba(56,189,248,0.25),transparent_55%)]"
                aria-hidden
              />
            </div>
          </div>
        ...
        <section className="grid gap-8 rounded-[3rem] border border-white/10 bg-white/5 p-10 lg:grid-cols-3">
          <div className="space-y-3">
            ...
            <p className="text-sm text-white/70">
              Relation directe, process transparents, obsession du détail. Chaque projet démarre par un cadrage
              stratégique pour aligner image, message et KPI.
            </p>
          </div>
          <div className="space-y-3">
            <h2 className="text-xl font-semibold">Équipe & réseau</h2>
            <p className="text-sm text-white/70">
              Collectif d&apos;opérateurs drone, motion designers, ingénieurs son, maquilleurs et assistants production
              pour dimensionner l&apos;équipe selon votre besoin.
            </p>
          </div>
          <div className="space-y-3">
            <h2 className="text-xl font-semibold">Stack 2025</h2>
            <p className="text-sm text-white/70">
              Sony Burano 8K · FX6 · DJI Inspire 3 & Avata 2 · Optiques G Master · Aputure Infinibar · Runway Gen-5 ·
              Sora Color Suite · Notion AI Ops.
            </p>
          </div>
        </section>
        ...
        <section className="space-y-6">
          ...
          <div className="grid gap-6 lg:grid-cols-3">
            {testimonials.map((t) => (
              <blockquote
                key={t.author}
                className="flex h-full flex-col gap-4 surface-card p-6"
              >
        ...
        <section className="space-y-10">
          <div className="section-heading">
            <span className="section-eyebrow">Services & Tarifs</span>
            <h2 className="section-title">Services phares</h2>
            <p className="section-description">
              Un aperçu des offres les plus demandées : corporate, événementiel, social media et motion design pilotés
          ...
          <div className="grid gap-6 lg:grid-cols-2">
            {servicesData.slice(0, 4).map((service) => (
              <article key={service.slug} className="surface-card p-6">
                ...
                <h3 className="mt-3 text-2xl font-semibold text-white">{service.name ?? service.title}</h3>
                <p className="mt-3 text-sm text-white/70">{service.subtitle ?? service.description}</p>
                <Link
        ...
        <section className="rounded-[3rem] border border-white/10 bg-gradient-to-br from-sky-500/20 via-indigo-500/20 to-fuchsia-500/20 p-10 text-sm text-white/75 backdrop-blur-2xl">
          ...
          <h2 className="mt-4 text-3xl font-extrabold text-white">
            Envie d&apos;échanger autour de votre prochain film ?
          </h2>
          <p className="mt-4 max-w-3xl">
            Décrivez votre projet, vos objectifs et vos délais : je reviens sous 24 h avec un premier cadrage
            budgétaire, un plan de tournage et des idées de diffusion.
          </p>
          <div className="mt-6 flex flex-wrap gap-4">
            <Link
              to="/contact"
              className="rounded-full border border-sky-300/40 bg-sky-500/25 px-6 py-3 text-xs font-semibold uppercase tracking-[0.35em] text-white"
            >
