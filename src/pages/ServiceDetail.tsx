      ...
      <div className="relative mx-auto flex w-full max-w-6xl flex-col gap-16 px-6 pb-24 pt-16 sm:px-10">
        ...
        <section className="grid gap-10 lg:grid-cols-[1.4fr_1fr]">
          <div className="space-y-8">
            ...
            {/* Essentiel du déroulement (préprod → livrables) si fourni */}
            {service.workflow && (
        ...
        <section className="space-y-6">
          ...
          {service.faqs?.length ? (
            ...
            <p className="text-sm text-white/70">Aucune question fréquente n&apos;est renseignée pour ce service.</p>
          )}
          <div className="rounded-[3rem] border border-white/10 bg-white/5 p-6 text-sm text-white/75">
            <h3 className="text-lg font-semibold text-white">Questions budgétaires & pratiques</h3>
            <p className="mt-2">
              Droits musicaux, révisions, délais précis, formats de livraison ou conditions de déplacement sont
              détaillés dans la{" "}
