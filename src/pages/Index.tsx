...
const heroHooks = [
  "Stratégies créatives orchestrées par l'IA",
  "Contenus premium conçus par nos équipes plateau",
  "Branding, motion et social media livrés en quelques jours",
];

const heroStats = [
  { value: "36h", label: "Mise en ligne moyenne" },
  { value: "12+", label: "Talents mobilisés par projet" },
              ...
              <div className="space-y-8">
                ...
                <h1 className="text-4xl font-black uppercase leading-[1.05] sm:text-5xl lg:text-[3.75rem]">
                  <span className="block text-xs font-semibold uppercase tracking-[0.55em] text-white/55">
                    Agence créative & production augmentée
                  </span>
                  <span className="mt-4 block text-[2.75rem] leading-[1.05] sm:text-[3.5rem] lg:text-[4.25rem]">
                    Studio VBG <span className="text-transparent bg-gradient-to-r from-rose-400 via-fuchsia-500 to-purple-500 bg-clip-text">propulse</span> votre image
                  </span>
                </h1>
                <p className="max-w-xl text-lg text-white/75">
                  Direction artistique, IA générative et équipes plateau travaillent en orchestration continue pour livrer des campagnes multi-formats qui marquent vos audiences.
                </p>
                ...
                <dl className="grid gap-4 pt-8 sm:grid-cols-3">
                  {heroStats.map((stat) => (
                    <div
                      key={stat.label}
                      className="rounded-3xl border border-white/10 bg-white/5 px-5 py-4 text-left shadow-[0_20px_60px_rgba(236,72,153,0.12)] backdrop-blur"
                    >
                      <dt className="text-xs font-semibold uppercase tracking-[0.4em] text-white/50">{stat.label}</dt>
                ...
                <div className="relative overflow-hidden rounded-[3rem] border border-white/15 bg-white/10 shadow-[0_40px_140px_rgba(236,72,153,0.35)] backdrop-blur">
                  ...
                  <div className="relative">
                    ...
                    <div className="absolute left-8 top-8 inline-flex items-center gap-2 rounded-full border border-white/30 bg-black/40 px-4 py-2 text-[0.6rem] font-semibold uppercase tracking-[0.35em] text-white/75 backdrop-blur">
                      {heroProject?.category ?? "Projet signature"}
                    </div>
                    <div className="absolute inset-x-0 bottom-0 rounded-b-[3rem] bg-gradient-to-t from-[#0b0617]/95 via-[#0b0617]/55 to-transparent px-8 pb-10 pt-16">
                      <div className="flex flex-wrap items-end justify-between gap-6">
                        <div className="space-y-3">
                          <p className="text-xs font-semibold uppercase tracking-[0.35em] text-white/45">Projet phare</p>
                          <p className="text-2xl font-bold text-white">{heroProject?.title ?? "Votre prochain lancement"}</p>
                          <p className="text-sm text-white/70">
                            {heroProject?.tagline ?? "Nous orchestrons branding, motion et production IA pour vos campagnes."}
                          </p>
