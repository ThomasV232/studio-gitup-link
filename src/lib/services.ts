...
export const servicesData: ServiceDetail[] = [
  {
    ...
    stack: [
      "Sony Burano 8K",
      "DaVinci Resolve Neural 19",
      "Notion Storyboard AI",
      "Runway Gen-3 Alpha",
    ],
    deliverables: [
    ...
    phases: [
      {
        ...
        description:
          "Session de cadrage 30 min pour prioriser vos messages, audiences et KPI.",
        aiUpgrade:
          "Synthèse automatique des enjeux et moodboard instantané partagé à l’équipe.",
      },
      {
        title: "Scénario & planning",
        description:
          "Scripts interview, repérages, organisation plateau et validation direction.",
        aiUpgrade: "Storyboard génératif + checklist logistique intelligente.",
      },
      {
        title: "Tournage cinématique",
        description:
          "Interviews multicam, B-roll immersif, captation audio double système.",
        aiUpgrade: "Téléprompteur adaptatif et monitoring colorimétrique en direct.",
      },
      {
        title: "Montage & révisions",
        description:
          "Montage narratif, motion léger, habillage sonore, 2 allers-retours inclus.",
        aiUpgrade: "Suggestions de cuts par IA vérifiées humainement pour accélérer les itérations.",
      },
      {
        title: "Activation multicanale",
        description:
          "Exports LinkedIn, YouTube, intranet + scripts de diffusion prêts à publier.",
        aiUpgrade: "Assistant publication pour générer posts et thumbnails optimisés.",
      },
    ],
    signatureMove:
      "Teaser 45 s livré sous 72 h pour vos comités ou campagnes teasing.",
    metrics: [
    ...
    phases: [
      {
        title: "Brief & objectifs",
        description:
          "30 min pour valider messages sponsor, moments forts et KPIs post-event.",
        aiUpgrade: "Feuille de route dynamique + scénarisation des séquences à capturer.",
      },
      {
        title: "Scénario & planning",
        description:
          "Run de production, repérages et coordination avec vos équipes scène et sécurité.",
        aiUpgrade: "Alertes logistiques IA (météo, flux visiteurs) et gestion accréditations.",
      },
      {
        title: "Tournage terrain",
        description:
          "Multi-cam, micro-trottoirs, drone FPV indoor, captation audio immersive.",
        aiUpgrade: "Reconnaissance VIP + tagging automatique pour retrouver les moments clés.",
      },
      {
        title: "Montage & révisions",
        description:
          "Montage express, étalonnage, sous-titres multilingues, brand kit sponsors.",
        aiUpgrade: "Templates IA pour générer hooks et variations verticales en temps réel.",
      },
      {
        title: "Diffusion",
        description:
          "Exports prêts LinkedIn, Insta, YouTube + kit médias pour vos partenaires.",
        aiUpgrade: "Analyse performance 72 h avec recommandations de relance.",
      },
    ],
    signatureMove:
      "Aftermovie livré en J+3 maximum, stories verticales pendant l’événement.",
    metrics: [
  ...
  },
  {
    ...
    deliverables: [
      ...
      "Photos HDR & plan de coupe (option)",
    ],
    phases: [
      {
        title: "Brief & objectifs",
        description:
          "Identification des arguments clés, calendrier et ciblage acquéreurs.",
        aiUpgrade: "Analyse du marché local + benchmark express des annonces concurrentes.",
      },
      {
        title: "Scénario & planning",
        description:
          "Storyboard visite, planning tournage et check-list home staging.",
        aiUpgrade: "Simulation de lumière horaire pour choisir le meilleur créneau.",
      },
      {
        title: "Tournage sur site",
        description:
          "Plans gimbal, drone intérieur/extérieur, détails architecturaux.",
        aiUpgrade: "Stabilisation gyroscopique IA + correction de perspective en direct.",
      },
      {
        title: "Montage & révisions",
        description:
          "Montage rythmé, titrage quartiers, étalonnage neutre luxe.",
        aiUpgrade: "Suggestions de call-to-action et miniatures optimisées.",
      },
      {
        title: "Activation",
        description:
          "Exports portails, réseaux sociaux, emailing + kit visuels.",
        aiUpgrade: "Génération d’annonces texte prêtes à publier.",
      },
    ],
    signatureMove:
      "Version verticale ADS incluse pour booster vos campagnes Meta/Google.",
    metrics: [
    ...
    phases: [
      {
        title: "Brief & objectifs",
        description:
          "Atelier éditorial pour prioriser vos campagnes, promos et piliers de contenu.",
        aiUpgrade: "Audit performance social + recommandations de formats IA.",
      },
      {
        title: "Scénario & planning",
        description:
          "Scripts hooks, plan de tournage batch et pré-production logistique.",
        aiUpgrade: "Générateur de variations de scripts pour A/B testing.",
      },
      {
        title: "Production agile",
        description:
          "Tournages 1/2 journée, B-roll snack, captation audio autonome.",
        aiUpgrade: "Sélection automatique des meilleures prises et cadrages.",
      },
      {
        title: "Montage & révisions",
        description:
          "Montage rapide, sous-titres animés, habillage motion réutilisable.",
        aiUpgrade: "Templates dynamiques et suggestions de cuts pour chaque plateforme.",
      },
      {
        title: "Pilotage",
        description:
          "Livraison hebdo, bibliothèque Notion, reporting mensuel détaillé.",
  ...
  },
  {
    ...
    deliverables: [
      "Film 5–8 minutes",
      "Bande-annonce 60 s",
      "Discours & moments bonus + galerie privée",
    ],
    phases: [
      {
        title: "Brief & objectifs",
        description:
          "Rencontre vidéo, intentions artistiques, planning avec le wedding planner.",
        aiUpgrade: "Moodboard émotionnel généré à partir de vos inspirations.",
      },
      {
        title: "Scénario & planning",
        description:
          "Storyline de la journée, repérages, coordination prestataires.",
        aiUpgrade: "Assistant planning pour anticiper les moments clés et la lumière.",
      },
      {
        title: "Tournage",
        description:
          "Captation discrète, audio haute fidélité, séquences super 8 en option.",
        aiUpgrade: "Focus tracking pour ne manquer aucun visage important.",
      },
      {
        title: "Montage & révisions",
        description:
          "Montage narratif, musique licenciée, 1 aller-retour inclus.",
        aiUpgrade: "Sélection musicale assistée par IA validée avec vous.",
      },
      {
        title: "Livraison",
        description:
          "Bande-annonce J+7, film final 3–6 semaines, coffret souvenir.",
    ...
    phases: [
      {
        title: "Brief & objectifs",
        description:
          "Atelier storytelling produit, identification des messages clés et KPI.",
        aiUpgrade: "Mindmap IA pour clarifier les parcours utilisateurs et objections.",
      },
      {
        title: "Scénario & planning",
        description:
          "Script, storyboard illustré, moodboard design et charte motion.",
        aiUpgrade: "Animatics génératifs + voix témoin pour valider rythme.",
      },
      {
        title: "Production",
        description:
          "Animation 2D/3D, simulations data, intégration UI et avatars.",
        aiUpgrade: "Textures génératives et avatars IA pilotés sur mesure.",
      },
      {
        title: "Montage & révisions",
        description:
          "Sound design, mixage multilingue, itérations ciblées.",
        aiUpgrade: "Traductions et doublages IA validés par relecture humaine.",
      },
      {
        title: "Activation",
        description:
          "Exports webinaire, landing page, réseaux sociaux + toolkit brand.",
