  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-slate-950 text-white">
      <div
        ...
        style={{ background: "radial-gradient(circle at 15% 15%, hsla(var(--visual-accent)/0.2), transparent 60%)" }}
      />
      <div
        className="pointer-events-none absolute inset-0"
        style={{ background: "radial-gradient(circle at 85% 85%, hsla(var(--visual-secondary)/0.2), transparent 60%)" }}
      />
      <div className="relative mx-auto max-w-5xl px-6 pb-32 pt-28">
        ...
        <form
          ...
          className="mt-16 space-y-8 rounded-[3rem] border border-white/10 bg-white/10 p-10 shadow-[0_20px_100px_rgba(236,72,153,0.2)]"
        >
