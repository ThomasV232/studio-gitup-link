          ...
          <div className="space-y-10">
            <div className="rounded-[3rem] border border-white/10 bg-white/10 p-10 shadow-[0_20px_100px_rgba(56,189,248,0.18)] visual-accent-veil">
              ...
              <form className="mt-6 grid gap-4" onSubmit={handleAddProject}>
                ...
                <button
                  type="submit"
                  className="self-start rounded-full border border-cyan-200/40 visual-accent-border bg-cyan-500/20 visual-accent-bg px-6 py-3 text-xs font-semibold uppercase tracking-[0.3em] text-white"
                >
