...
const Index = () => {
  ...
  return (
    <PageShell
      ...
      contentClassName="gap-20 pb-28"
    >
      <HeroRibbon />
      <main className="page-container">
        {/* HERO */}
          <section className="surface-panel relative overflow-hidden p-10 sm:p-12 lg:p-16">
          <div
          ...
          <div className="relative grid gap-14 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
            <div className="space-y-8">
              ...
              <span className={cn("section-eyebrow", "border-white/25 bg-white/10 text-white/80")}>Studio VBG · Stack vidéo Sept. 2025</span>
              <h1 className="space-y-6 text-balance font-semibold">
                <span className="block text-[0.78rem] font-semibold uppercase tracking-[0.48em] text-white/55">
        ...
        <section className="space-y-12">
          <div className="flex flex-col gap-6 sm:flex-row sm:items-end sm:justify-between">
            <SectionHeading
              eyebrow="Extraits Réalisations"
              title="6 catégories, un même niveau d'exigence"
              description="Sélectionnez un extrait pour visualiser notre rendu colorimétrique, le soin apporté aux interviews et la fluidité des transitions motion."
            />
            <Link
              to="/realisations"
              className="inline-flex h-fit items-center gap-3 rounded-full border border-white/20 bg-white/10 px-6 py-3 text-[0.7rem] font-semibold uppercase tracking-[0.32em] text-white transition hover:bg-white/15"
            >
        ...
        <section className="space-y-10">
          <SectionHeading
            ...
            title="Des packs maîtrisés pour chaque catégorie"
            description="Pipeline préproduction → production → postproduction → diffusion. Les packs Journée, Weekend ou Sur demande s'adaptent à vos enjeux et intègrent IA, sous-titres et miniatures."
          />
        ...
        {/* PROCESS */}
        <section className="surface-card p-10 sm:p-12">
          <SectionHeading
            eyebrow="Processus / Méthode"
            title="Une méthode éprouvée, adaptée à chaque service"
            description="Chaque étape est documentée, automatisée quand c'est pertinent et pilotée par un chef de projet unique. Objectif : fluidité, visibilité, impact."
          />
        ...
        <section className="space-y-10">
          <SectionHeading
            ...
            description="Réalisations corporate, événements, réseaux sociaux : un suivi constant et des résultats mesurables."
          />
          <div className="grid gap-6 lg:grid-cols-3">
        ...
        {/* CONTACT & DEVIS */}
        <section className="surface-panel p-10 sm:p-12">
          <div className="grid gap-10 lg:grid-cols-[0.9fr_1.1fr] lg:items-start">
            <div className="space-y-6">
              <SectionHeading
                eyebrow="Contact & Devis"
                title="Parlez-nous de votre prochain tournage"
                description="Décrivez votre projet (type de vidéo, deadline, KPI) : nous revenons vers vous sous 24 h avec budget estimatif, planning et premières idées d'activation."
              />
